...
export function OpinionsContextProvider({ children }) {
  ...
  async function upvoteOpinion(id) {
   const response = await fetch(`${import.meta.env.VITE_API_URL}opinions/${id}/upvote`, {
      method: 'POST',
    });
  ...
  async function downvoteOpinion(id) {
   ...
   const response = await fetch(`${import.meta.env.VITE_API_URL}opinions/${id}/downvote`, {
      method: 'POST',
    });
